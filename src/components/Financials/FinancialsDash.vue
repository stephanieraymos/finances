<template>
    ...
    <h2 @click="toggleBillsVisibility" :class="{ collapsible: true, collapsed: billsCollapsed }" style="cursor: pointer; margin-top: 0.5rem;">
        Upcoming Bills
    </h2>
  ...
  .bill-list {
    ...
    .bill-item {
      ...
      &:hover {
        ...
        background: #475569; /* Slightly lighter hover effect */
      }
