                ...
                <div class="modal-overlay" @click.self="showModal = false">
                    <div class="modal">
                        ...
                        <form @submit.prevent="addItem">
                            ...
                            <label>
                                Platform:
                                <input v-model="newItem.platforms" type="text" required />
                            </label>
                            <label>
                                Rating:
                            ...
                            <div class="modal-actions">
                                <button type="submit" class="save-btn" @click="saveNewWatchListItem()">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
...
async function deleteItem(id) {
    ...
    for (const status in watchList.value) {
        watchList.value[status] = watchList.value[status].filter(item => item.id !== id);
    }
}
